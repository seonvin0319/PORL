...
# Actor는 networks.py의 TanhGaussianMLP로 통합됨
...
class EDACAlgorithm(PyTorchAlgorithmInterface):
    """EDAC 알고리즘의 POGO Multi-Actor 인터페이스 구현"""
    def __init__(self, trainer: 'EDAC'):
    ...
    def update_critic(
        ...
        **kwargs
        ...
        """EDAC의 Alpha, Critic 업데이트 (diversity loss 포함)"""
        ...
        # Critic update (diversity loss 포함)
