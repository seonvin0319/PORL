...
def main(config: Config):
    ...
    print("---------------------------------------", flush=True)
    print(f"Training POGO Multi-Actor (JAX), Env: {config.dataset_name}, Seed: {config.train_seed}", flush=True)
    ...
    final_eval_episodes = getattr(config, "final_eval_episodes", config.eval_episodes)
    print("\n" + "=" * 60, flush=True)
