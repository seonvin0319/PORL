#!/bin/bash
# IQL, AWAC 환경별 seed 0 순차 실행
# D4RL MuJoCo: halfcheetah, hopper, walker2d (medium, medium-expert, medium-replay)
# wandb: config use_wandb 기본 true. 비활성화: python에 --no_wandb 추가
...
run_algorithm() {
    ...
    echo ""
    echo "=========================================="
    echo "  $ALG 전체 환경 순차 학습 (seed $SEED)"
    echo "=========================================="
...
echo "=========================================="
echo "IQL + AWAC 환경별 seed0 실행"
echo "=========================================="

run_algorithm "iql" "configs/offline/iql_pogo_base.yaml"
run_algorithm "awac" "configs/offline/awac_pogo_base.yaml"
